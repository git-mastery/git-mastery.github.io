...
1. Check your progress repo (at `https://github.com/{YOUR_USERNAME}/{YOUR_USERNAME}-gitmastery-progress` e.g.,`https://github.com/johndoe/johndoe-gitmastery-progress`) to confirm that the latest commit in there has a timestamp after you completed the latest exercise.<br>
...
1. If none of the above resolves the issue, file a help request through [our issue tracker](https://github.com/git-mastery/issues).
