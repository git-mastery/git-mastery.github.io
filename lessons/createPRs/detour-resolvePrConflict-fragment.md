...
1. Push the PR branch to your fork. As the updated code in that branch no longer is conflicting with the `main` branch, the merge conflict alert in the PR will go away automatically.
