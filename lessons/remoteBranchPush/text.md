...
{{ hp_number(hop_preparation) }} **Fork the [samplerepo-company](https://github.com/git-mastery/samplerepo-company)** to your GitHub account. When doing so, ==un-tick the <code>Copy the master branch only</code> option==.<br>
