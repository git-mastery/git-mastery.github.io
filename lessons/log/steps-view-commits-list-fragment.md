...
{{ icon_info }} Note how the output includes details about the commit you just created. You can ignore most of them for now, but notice that it also shows the commit message you provided.
