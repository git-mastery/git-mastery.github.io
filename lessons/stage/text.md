...
{% set lesson_data = trail.recordingFolderHistory.lessons.stage %}
...
{{ show_previous_link(lesson=trail.recordingFolderHistory.lessons.init) }}{{ show_next_link(lesson=trail.recordingFolderHistory.lessons.commit) }}
</div>
