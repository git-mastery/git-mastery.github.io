...
1. **{{ m.show_git_term("Untrack") }} the file (i.e., remove the file from the staging area and stop tracking it in the future)**, using the `git rm --cached <file(s)>` command.
   ```bash
