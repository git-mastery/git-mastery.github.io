...
{{ hp_number(hop_preparation) }} **Fork the [samplerepo-books](https://github.com/git-mastery/samplerepo-books)** to your GitHub account. When doing so, ==un-tick the `Copy the master branch only` option==.<br>
