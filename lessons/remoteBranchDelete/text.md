...
{% set lesson_data = trail.remoteBranches.lessons.remoteBranchDelete %}
...
<pic src="{{baseUrl}}/lessons/remoteBranchDelete/images/sourcetreeRightClickToDelete.png" width="300" />
...
{{ show_previous_link(lesson=trail.remoteBranches.lessons.remoteBranchPull) }}{{ show_next_link(lesson=trail.remoteBranches.lessons.remoteBranchRename) }}
</div>
<div id="extras">
