...
{{ show_previous_link(lesson=trail.recordingFolderHistory.lessons.intro) }}{{ show_next_link(lesson=trail.recordingFolderHistory.lessons.init) }}
</div>
