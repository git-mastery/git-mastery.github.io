...
When Git initializes a repo in a folder, it does not touch any files in the folder, other than to create the `.git` folder and its contents. So, reversing the operation is as simple as deleting the newly-created `.git` folder.
