...
{% set lesson_data = trail.managingProjects.lessons.otherPmFeatures %}
...
{{ show_previous_link(lesson=trail.managingProjects.lessons.forkingWorkflow) }}{{ show_next_link(tour=trail.managingProjects, part="outro") }}
</div>
