...
{% set lesson_data = trail.workingWithRemotes.lessons.clone %}
...
{{ show_previous_link(lesson=trail.workingWithRemotes.lessons.fork) }}{{ show_next_link(lesson=trail.workingWithRemotes.lessons.pull) }}
</div>
