...
{% set lesson_data = trail.fineTuningHistory.lessons.interactiveRebase %}
...
{{ show_previous_link(lesson=trail.fineTuningHistory.lessons.commitMessage) }}{{ show_next_link(tour=trail.fineTuningHistory, part="outro") }}
</div>
<div id="extras">
