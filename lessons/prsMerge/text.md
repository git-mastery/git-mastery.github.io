...
{% set lesson_data = trail.workingWithPrs.lessons.prsMerge %}
...
{{ show_previous_link(lesson=trail.workingWithPrs.lessons.prsReview) }}{{ show_next_link(tour=trail.workingWithPrs, part="outro") }}
</div>
