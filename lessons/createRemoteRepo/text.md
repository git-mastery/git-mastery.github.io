...
{{ hp_number ('2') }} **In the next screen, provide `gm-sports` as the name for your repo**. Refer the screenshot below on some guidance on how to provide the required information.<br>
...
{{ hp_number ('3') }} **Note the URL of the repo.** It will be of the form<br> `https://github.com/{your_user_name}/{repo_name}.git`.<br>
   e.g., `https://github.com/johndoe/gm-sports.git` (note the `.git` at the end)<br>
