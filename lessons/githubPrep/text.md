...
**1. Download and run the installer** from the [GitHub CLI releases page](https://github.com/cli/cli/releases). This is the file named `GitHub CLI {version} windows {chip variant} installer`.<br>
...
{{ show_previous_link(lesson=trail.backingUpOnCloud.lessons.remoteRepos) }}{{ show_next_link(lesson=trail.backingUpOnCloud.lessons.createRemoteRepo) }}
</div>
